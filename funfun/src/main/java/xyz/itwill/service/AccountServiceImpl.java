...
public class AccountServiceImpl implements AccountService {
   ...
   @Override
   public Account idSearch(Account search) {
       System.out.println("idSearch method called with name: " + search.getName() + " and email: " + search.getEmail());
       Account result = accountDAO.idSearch(search);
       System.out.println("idSearch result: " + result);
       return result;
   }*/
   
   //비밀번호 찾기   
      /*@Override
      public void findPassword(HttpServletResponse response, Account account) throws Exception {
         ...
         out.print("이메일로 임시 비밀번호를 발송하였습니다. 확인 후 로그인해주세요.");
         out.close();
      }*/
   ...
   private void sendTemporaryPasswordByEmail(String recipientEmail, String temporaryPassword) {
      // SMTP 서버 설정
       ...
       try {
          ...
          htmlContent += "<p>임시 비밀번호는 <span style='font-size: 20px; font-weight: bold;'>" + temporaryPassword + "</span> 입니다.</p>";
