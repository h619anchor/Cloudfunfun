        ...
        <div class="row">
            ...
            <div class="col-sm-10 account-info">
                <div id="my-donations" class="account-info-content">
                    ...
                    <button id="submit-modify-main" type="submit">저장</button>&nbsp;&nbsp;
                   	<button id="cancel-modify-main" type="button">취소</button>
                ...
                <div id="my-orders" class="account-info-content">
                    ...
                    <div id="expectListDiv"></div>
                   	<button id="submit-modify-expect" type="submit">저장</button>&nbsp;&nbsp;
                   	<button id="cancel-modify-expect" type="button">취소</button>
	    ...
	    $.ajax({
	        ...
	        success: function (result) {
	    	   ...
	    	   for (var i = 0; i < result.indexMainFestival.length; i++) {
	    	       ...
	    	       var selectedDiv = $("<div>").addClass("col-xs-6 col-md-3 product");
	    	       
	    	       var selectedA = $("<a>").attr('href', 'javascript:festivalDetail(' + selected.idx + ');').addClass('product-link');
	    	       
	    	       var selectedImg = $("<img>").attr("src", '<c:url value="/resources/upload/' + selected.mainImg + '" />').attr("alt", selected.subject + " 포스터");
	    	       
	    	       var shopTitleDiv = $("<div>").addClass("shop_title");
	    	       
	    	       var strongTitle = $("<h3>").addClass("product-title").text(selected.subject);
